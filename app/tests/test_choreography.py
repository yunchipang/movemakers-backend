...
def test_get_all_choreos(test_app, choreography_id):
...
def test_get_choreography(test_app, choreography_id):
...
def test_update_choreography(test_app, choreography_id):
...
def test_delete_choreography(test_app, choreography_id):
