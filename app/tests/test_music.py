def test_get_all_music(test_app, core_spotify_track_id):
...
def test_get_music(test_app, core_spotify_track_id):
...
def test_update_music(test_app, core_spotify_track_id):
    updated_payload = {
...
def test_delete_music(test_app, core_spotify_track_id):
    # delete the music
