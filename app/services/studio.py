...
async def create_studio(studio: studio_schemas.CreateStudio, db: "Session") -> studio_schemas.Studio:
...
async def get_studio(studio_id: int, db: "Session"):
    studio = db.query(studio_models.Studio).filter(studio_models.Studio.id == studio_id).first()
    return studio
...
async def update_studio(
        studio_data: studio_schemas.CreateStudio, studio: studio_models.Studio, db: "Session"
